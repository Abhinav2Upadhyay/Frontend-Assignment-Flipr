      ...
      <footer className="px-16 py-12 text-white bg-black">
        <div className="flex justify-between mb-10">
            ...
            <ul className="flex items-center gap-5 font-semibold">
              ...
              <li className="cursor-pointer hover:text-sky-300 hover:border-b-2 hover:border-sky-300" onClick={() => navigate("/about-us")}>About Us</li>
              ...
              <li className="cursor-pointer hover:text-sky-300 hover:border-b-2 hover:border-sky-300" onClick={() => navigate("/privacy-policy")}>Privacy Policy</li>
            </ul>
        </div>
