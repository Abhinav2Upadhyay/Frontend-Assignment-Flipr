  ...
  return (
    <>
      ...
      <section className="relative w-full">
        ...
        <div className="bg-black bg-opacity-30 w-full text-white top-0 z-[1] h-[600px] md:h-[500px] sm:h-[400px] flex items-center sm:justify-start justify-center sm:px-0 px-6">
